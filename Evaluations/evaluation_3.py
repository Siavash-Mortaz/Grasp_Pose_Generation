...
condition_dim = 30
latent_dim = 64
weights_path=['cvae_02_weights_2.pth','cvae_02_1_weights.pth','cvae_02_2_weights.pth']
mse_models=[]
mae_models=[]

for i in range(len(weights_path)):
    if weights_path[i]=='cvae_02_weights_2.pth':
        print('CVAE_02')
        model_name = 'Model 02'
        model = CVAE_02(input_dim, latent_dim, condition_dim)
    elif weights_path[i]=='cvae_02_1_weights.pth':
        print('CVAE_02_1')
        model_name = 'Model 04'
...
axes[0].bar('CVAE_02(3rd)', mse_models[0], label='Ltn=64, lr=0.0005, Ep=200',color='red')
axes[0].bar('CVAE_02_1', mse_models[1],label='Add Layers', color='orange')
axes[0].bar('CVAE_02_2', mse_models[2],label='Add More Layers', color='purple')
...
axes[1].bar('CVAE_02(3rd)', mae_models[0],label='Ltn=64, lr=0.0005, Ep=200', color='red')
axes[1].bar('CVAE_02_1', mae_models[1],label='Add Layers', color='orange')
axes[1].bar('CVAE_02_2', mae_models[2],label='Add More Layers', color='purple')
