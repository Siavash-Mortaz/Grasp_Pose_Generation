...
from Models_Trains.all_models import CVAE_02_3  # Assuming you've renamed your model as ModifiedCVAE
...
latent_dim = 64  # 32 or 64 depending on your experiments
...
for epoch in range(num_epochs):
    ...
    for batch in train_loader:
        ...
        optimizer.zero_grad()
        # Encode hand pose without condition
        mean, log_var = model.encode(hand_pose_data)
        # Reparameterize to get latent vector
        z = model.reparameterize(mean, log_var)
        # Decode with condition to reconstruct hand pose
...
# Save the model
torch.save(model.state_dict(), 'cvae_02_3_weights.pth')
...
with open('cvae_02_3_losses_errors.pkl', 'wb') as f:
