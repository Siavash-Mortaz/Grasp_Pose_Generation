...
hand_train, hand_val, hand_test, obj_train, obj_val, obj_test, train_dataset, val_dataset, test_dataset, train_loader, val_loader, test_loader, obj_name=loading_data('../PreprocessData/hand_object_data.pkl',64)
...
# Save the model
torch.save(model.state_dict(), '/cvae_01_weights.pth')
print("Model saved successfully!")

# Save the losses and errors
losses_errors = {
    't_loss': t_loss,
    'v_loss': v_loss,
...
with open('/cvae_01_losses_errors.pkl', 'wb') as f:
