...
axes[0].plot(t_loss_1, label='CVAE_02(3rd)', color='red')
axes[0].plot(t_loss_2, label='CVAE_02_1', color='orange')
axes[0].plot(t_loss_3, label='CVAE_02_2', color='purple')
...
axes[1].plot(v_loss_1, label='CVAE_02(3rd)', color='red')
axes[1].plot(v_loss_2, label='CVAE_02_1', color='orange')
axes[1].plot(v_loss_3, label='CVAE_02_2', color='purple')
...
axes[2].plot(v_rec_loss_1, label='CVAE_02(3rd)', color='red')
axes[2].plot(v_rec_loss_2, label='CVAE_02_1', color='orange')
axes[2].plot(v_rec_loss_3, label='CVAE_02_2', color='purple')
...
axes[3].plot(v_pose_error_1, label='CVAE_02(3rd)', color='red')
axes[3].plot(v_pose_error_2, label='CVAE_02_1', color='orange')
axes[3].plot(v_pose_error_3, label='CVAE_02_2', color='purple')
...
axes[4].plot(v_joints_error_1, label='CVAE_02(3rd)', color='red')
axes[4].plot(v_joints_error_2, label='CVAE_02_1', color='orange')
axes[4].plot(v_joints_error_3, label='CVAE_02_2', color='purple')
...
axes[5].plot(v_trans_error_1, label='CVAE_02(3rd)', color='red')
axes[5].plot(v_trans_error_2, label='CVAE_02_1', color='orange')
axes[5].plot(v_trans_error_3, label='CVAE_02_2', color='purple')
